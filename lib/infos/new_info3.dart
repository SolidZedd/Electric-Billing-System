...
class NewInfo3 extends StatefulWidget {
  final String textFromFile;

  const NewInfo3({Key? key, required this.textFromFile}) : super(key: key);

  @override
  State<NewInfo3> createState() => _NewInfo3State();
}

class _NewInfo3State extends State<NewInfo3> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-201');
  final meterController = TextEditingController(text: '10');
  final consumerController = TextEditingController(text: '17');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-201 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-201 pic2.jpg');
