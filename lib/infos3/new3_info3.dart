...
class New3Info3 extends StatefulWidget {
  const New3Info3({Key? key}) : super(key: key);

  @override
  State<New3Info3> createState() => _New3Info3State();
}

class _New3Info3State extends State<New3Info3> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-129');
  final meterController = TextEditingController(text: '116');
  final consumerController = TextEditingController(text: '210');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-129 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-129 pic2.jpg');
