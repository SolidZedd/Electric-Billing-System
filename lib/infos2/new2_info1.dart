...
class New2Info1 extends StatefulWidget {
  const New2Info1({Key? key}) : super(key: key);

  @override
  State<New2Info1> createState() => _New2Info1State();
}

class _New2Info1State extends State<New2Info1> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-122');
  final meterController = TextEditingController(text: '4');
  final consumerController = TextEditingController(text: '85');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-122 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-122 pic2.jpg');
