...
class New3Info2 extends StatefulWidget {
  const New3Info2({Key? key}) : super(key: key);

  @override
  State<New3Info2> createState() => _New3Info2State();
}

class _New3Info2State extends State<New3Info2> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-806');
  final meterController = TextEditingController(text: '107');
  final consumerController = TextEditingController(text: '80');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-806 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-806 pic2.jpg');
