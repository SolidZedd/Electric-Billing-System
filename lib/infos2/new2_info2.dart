...
class New2Info2 extends StatefulWidget {
  const New2Info2({Key? key}) : super(key: key);

  @override
  State<New2Info2> createState() => _New2Info2State();
}

class _New2Info2State extends State<New2Info2> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-555');
  final meterController = TextEditingController(text: '110');
  final consumerController = TextEditingController(text: '87');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-555 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-555 pic2.jpg');
