...
class New2Info3 extends StatefulWidget {
  const New2Info3({Key? key}) : super(key: key);

  @override
  State<New2Info3> createState() => _New2Info3State();
}

class _New2Info3State extends State<New2Info3> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-101');
  final meterController = TextEditingController(text: '93');
  final consumerController = TextEditingController(text: '33');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-101 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-101 pic2.jpg');
