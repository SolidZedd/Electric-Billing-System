...
class ConsumerInfo2 extends StatefulWidget {
  const ConsumerInfo2({Key? key}) : super(key: key);

  @override
  State<ConsumerInfo2> createState() => _ConsumerInfo2State();
}

class _ConsumerInfo2State extends State<ConsumerInfo2> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-410');
