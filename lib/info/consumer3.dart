...
class ConsumerInfo3 extends StatefulWidget {
  const ConsumerInfo3({Key? key}) : super(key: key);

  @override
  State<ConsumerInfo3> createState() => _ConsumerInfo3State();
}

class _ConsumerInfo3State extends State<ConsumerInfo3> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-177');
  final meterController = TextEditingController(text: '100');
  final consumerController = TextEditingController(text: '45');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-128 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-128 pic2.jpg');
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(top: 20, bottom: 20, right: 200),
                    child: TextField(
                      decoration: InputDecoration(
                        border: UnderlineInputBorder(),
