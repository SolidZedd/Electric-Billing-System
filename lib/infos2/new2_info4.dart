...
class New2Info4 extends StatefulWidget {
  const New2Info4({Key? key}) : super(key: key);

  @override
  State<New2Info4> createState() => _New2Info4State();
}

class _New2Info4State extends State<New2Info4> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-57');
  final meterController = TextEditingController(text: '54');
  final consumerController = TextEditingController(text: '32');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-57 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-57 pic2.jpg');
