...
class New3Info4 extends StatefulWidget {
  const New3Info4({Key? key}) : super(key: key);

  @override
  State<New3Info4> createState() => _New3Info4State();
}

class _New3Info4State extends State<New3Info4> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-180');
  final meterController = TextEditingController(text: '401');
  final consumerController = TextEditingController(text: '111');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-180 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-180 pic2.jpg');
