...
class NewInfo1 extends StatefulWidget {
  final String textFromFile;

  const NewInfo1({Key? key, required this.textFromFile}) : super(key: key);

  @override
  State<NewInfo1> createState() => _NewInfo1State();
}

class _NewInfo1State extends State<NewInfo1> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-160');
  final meterController = TextEditingController(text: '11');
  final consumerController = TextEditingController(text: '7');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-160 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-160 pic2.jpg');
