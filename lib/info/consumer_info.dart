...
class ConsumerInfo1 extends StatefulWidget {
  final String textFromFile;

  const ConsumerInfo1({Key? key, required this.textFromFile}) : super(key: key);

  @override
  State<ConsumerInfo1> createState() => _ConsumerInfo1State();
}

class _ConsumerInfo1State extends State<ConsumerInfo1> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-550');
