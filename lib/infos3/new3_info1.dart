...
class New3Info1 extends StatefulWidget {
  const New3Info1({Key? key}) : super(key: key);

  @override
  State<New3Info1> createState() => _New3Info1State();
}

class _New3Info1State extends State<New3Info1> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-159');
  final meterController = TextEditingController(text: '22');
  final consumerController = TextEditingController(text: '122');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-159 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-159 pic2.jpg');
