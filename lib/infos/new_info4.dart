...
class NewInfo4 extends StatefulWidget {
  final String textFromFile;

  const NewInfo4({Key? key, required this.textFromFile}) : super(key: key);

  @override
  State<NewInfo4> createState() => _NewInfo4State();
}

class _NewInfo4State extends State<NewInfo4> {
  String text = '';
  String text2 = '';
  String text3 = '';
  String text4 = '';
  ...
  final folioController = TextEditingController(text: 'P-480');
  final meterController = TextEditingController(text: '63');
  final consumerController = TextEditingController(text: '20');
  ...
  Future<File> saveImagePermanently(String imagePath) async {
    ...
    final name = basename('Folio P-480 pic1.jpg');
  ...
  Future<File> saveImage(String path) async {
    ...
    final name = basename('Folio P-480 pic2.jpg');
